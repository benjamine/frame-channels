...
(function(e){var r=require("./channel");if(exports.Channel=r,exports.create=function(e,o){return new r(e,o)},e.browser)exports.version="0.0.64",exports.homepage="https://github.com/benjamine/frame-channels";else{var o=require("../package.json");exports.version=o.version,exports.homepage=o.homepage}}).call(this,require("_process"));
